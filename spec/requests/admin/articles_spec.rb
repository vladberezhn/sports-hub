  ...
  describe "POST /create" do
    context "with valid parameters" do
      ...
      it "redirects to the created admin_article" do
        post admin_articles_url, params: { admin_article: valid_attributes }
        expect(response).to redirect_to(admin_article_url(@admin_article))
      end
    end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested admin_article" do
        article = Admin::Article.create! valid_attributes
        patch admin_article_url(admin_article), params: { admin_article: new_attributes }
        article.reload
    ...
    context "with invalid parameters" do
      it "renders a successful response (i.e. to display the 'edit' template)" do
        article = Admin::Article.create! valid_attributes
        patch admin_article_url(admin_article), params: { admin_article: invalid_attributes }
        expect(response).to be_successful
      end
    end
  end
